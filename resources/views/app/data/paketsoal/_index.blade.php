...
@section('content')
<h3 class="text-gray-700 text-3xl font-medium">Paket Soal</h3>
<div class="container bg-white p-10 my-10" x-data="paketsoalCrud()">
    ...
    <x-modal :value="1">
        ...
        <div class="border-b-2 border-black mb-4">
            <h2 class="text-3xl font-medium" :id="$id('modal-title')">Form Data Paket Soal</h2>
        </div>
        <!-- Content -->
        <form action="#" @submit.prevent="confirmSave">
            <div class="flex flex-wrap -mx-3 mb-6">
                ...
                <div class="w-full px-3 my-3">
                    <label class="block tracking-wide text-gray-700 text-sm font-bold mb-2" for="desc">
                        Deskripsi
                    </label>
                    <textarea name="desc" x-model="form.desc"
                    class="w-full h-24 px-3 py-2 text-base text-gray-700 placeholder-gray-300 border rounded-lg focus:shadow-outline" 
                    type="text" 
                    placeholder="No. Peserta"></textarea>
                    <small x-text="errMsg.desc" class="ml-3 text-xs text-red-500"></small>
                </div>
                <div class="w-full px-3 my-3">
                    <label class="block tracking-wide text-gray-700 text-sm font-bold mb-2" for="type">
                        Tipe
                    </label>
...
@section('_inJs')
@include('app.data.paketsoal._inJs')
@endsection
<!-- /Your Custom Javascript -->