...
@section('title', ' | Kolom : ' . $paketsoal->name)

@section('content')
<h3 class="text-gray-700 text-3xl font-medium">Kolom Paket Soal : {{ $paketsoal->name }}</h3>
<div class="container bg-white p-10 my-10" x-data="kolomCrud()">
    ...
    <x-modal :value="1">
        ...
        <div class="border-b-2 border-black mb-4">
            <h2 class="text-3xl font-medium" :id="$id('modal-title')">Form Data Kolom</h2>
        </div>
        <!-- Content -->
        <form action="#" @submit.prevent="confirmSave">
            <div class="grid grid-flow-col grid-cols-5 -mx-3 mb-6">
                <div class="w-full px-3 my-3">
                    <label class="block tracking-wide text-gray-700 text-sm font-bold mb-2" for="col_a">
                        A
                    </label>
                    <input name="col_a" x-model="form.col_a"
                    class="w-full h-10 px-3 text-base text-gray-700 placeholder-gray-300 border rounded-lg focus:shadow-outline" 
                    type="text" 
                    placeholder="A">
                    <small x-text="errMsg.col_a" class="ml-3 text-xs text-red-500"></small>
                </div>
                <div class="w-full px-3 my-3">
                    <label class="block tracking-wide text-gray-700 text-sm font-bold mb-2" for="col_b">
                        B
                    </label>
                    <input name="col_b" x-model="form.col_b"
                    class="w-full h-10 px-3 text-base text-gray-700 placeholder-gray-300 border rounded-lg focus:shadow-outline" 
                    type="text" 
                    placeholder="B">
                    <small x-text="errMsg.col_b" class="ml-3 text-xs text-red-500"></small>
                </div>
                <div class="w-full px-3 my-3">
                    <label class="block tracking-wide text-gray-700 text-sm font-bold mb-2" for="col_c">
                        C
                    </label>
                    <input name="col_c" x-model="form.col_c"
                    class="w-full h-10 px-3 text-base text-gray-700 placeholder-gray-300 border rounded-lg focus:shadow-outline" 
                    type="text" 
                    placeholder="C">
                    <small x-text="errMsg.col_c" class="ml-3 text-xs text-red-500"></small>
                </div>
                <div class="w-full px-3 my-3">
                    <label class="block tracking-wide text-gray-700 text-sm font-bold mb-2" for="col_d">
                        D
                    </label>
                    <input name="col_d" x-model="form.col_d"
                    class="w-full h-10 px-3 text-base text-gray-700 placeholder-gray-300 border rounded-lg focus:shadow-outline" 
                    type="text" 
                    placeholder="D">
                    <small x-text="errMsg.col_d" class="ml-3 text-xs text-red-500"></small>
                </div>
                <div class="w-full px-3 my-3">
                    <label class="block tracking-wide text-gray-700 text-sm font-bold mb-2" for="col_e">
                        E
                    </label>
                    <input name="col_e" x-model="form.col_e"
                    class="w-full h-10 px-3 text-base text-gray-700 placeholder-gray-300 border rounded-lg focus:shadow-outline" 
                    type="text" 
                    placeholder="E">
                    <small x-text="errMsg.col_e" class="ml-3 text-xs text-red-500"></small>
                </div>                
            </div>
            <!-- Buttons -->
    ...
    <!-- ini datatable -->
    <livewire:data.kolom-table id="{{ $paketsoal->id }}"  />
    <!-- ini datatable -->
</div>
@endsection
